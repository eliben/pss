...
_pss_complete() 
{
    ...
    # COMP_WORDS is an array of words in the current command line. COMP_CWORD
    # is the index of the current word (the one the cursor is in).
    # So COMP_WORDS[COMP_CWORD] is the current word; we also record the previous
    # word here, although this specific script doesn't use it yet.
    ...
    if [[ ${cur_word} == -* ]] ; then
        # COMPREPLY is the array of possible completions, generated with the
        # compgen builtin.
